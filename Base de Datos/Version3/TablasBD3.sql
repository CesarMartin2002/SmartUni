...
-- object: public.Historico_aula | type: TABLE --
-- DROP TABLE IF EXISTS public.Historico_aula CASCADE;
...
-- ddl-end --
ALTER TABLE public.Historico_aula OWNER TO aotdlhvi;
-- ddl-end --

-- object: Aula_fk | type: CONSTRAINT --
-- ALTER TABLE public.Historico_aula DROP CONSTRAINT IF EXISTS Aula_fk CASCADE;
ALTER TABLE public.Historico_aula ADD CONSTRAINT Aula_fk FOREIGN KEY (id_aula_Aula)
REFERENCES public.Aula (id_aula) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
