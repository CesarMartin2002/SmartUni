...
INSERT INTO ASIGNATURA VALUES (1,'Gestion de Proyectos');
INSERT INTO ASIGNATURA VALUES (2, 'Sistemas Empresariales');
INSERT INTO ASIGNATURA VALUES (3,'Estructuras Discretas');
INSERT INTO ASIGNATURA VALUES (4,'CRA');
INSERT INTO ASIGNATURA VALUES (5,'Gestion de Proyectos');
--SELECT * FROM ASIGNATURA;

--PEDIDO(id, estado, id_alumno)
INSERT INTO PEDIDO VALUES (1,'0',3);
INSERT INTO PEDIDO VALUES (2,'0',3);
INSERT INTO PEDIDO VALUES (3,'0',3);
--SELECT * FROM PEDIDO

--PEDIDO_PRODUCTO (id, id_pedido, id_producto)
INSERT INTO PEDIDO_PRODUCTO VALUES (1,1,1);
INSERT INTO PEDIDO_PRODUCTO VALUES (2,2,2);
INSERT INTO PEDIDO_PRODUCTO VALUES (3,2,3);
INSERT INTO PEDIDO_PRODUCTO VALUES (4,3,1);
INSERT INTO PEDIDO_PRODUCTO VALUES (5,3,2);
INSERT INTO PEDIDO_PRODUCTO VALUES (6,3,3);
--SELECT * FROM PEDIDO_PRODUCTO

--NFC (id, id_pedido, num_serie)
INSERT INTO NFC VALUES (1,null,'04:3c:b0:56:70:00:00');
INSERT INTO NFC VALUES (2,null,'04:ef:8e:56:70:00:00');
--SELECT * FROM NFC

--HORARIO (id, dia, hora_inicio, hora_fin, id_asignatura, id_aula)
INSERT INTO HORARIO VALUES (1,'2023/05/30','08:00','10:00',1, 1);
INSERT INTO HORARIO VALUES (2,'2023/05/31','08:00','10:00',1, 2);
--SELECT * FROM HORARIO
