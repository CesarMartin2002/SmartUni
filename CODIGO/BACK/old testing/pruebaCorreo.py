...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Te damos la bienvenida a SmartUni, la plataforma educativa líder en línea. Estamos emocionados de tenerte como parte de nuestra comunidad.</p>
      <p>Con SmartUni, podrás acceder a una amplia gama de cursos y recursos de aprendizaje. Estamos comprometidos a brindarte una experiencia educativa de calidad y apoyarte en tu crecimiento académico y profesional.</p>
